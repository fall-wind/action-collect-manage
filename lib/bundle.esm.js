import { Subject, VirtualTimeScheduler, merge } from 'rxjs';
...
var ActionCollectManage = /** @class */ (function () {
    ...
    ActionCollectManage.prototype.registerActive = function (key, actionList, cb) {
        ...
        var subject = merge.apply(void 0, subjectArr).pipe(observeOn(scheduler))
...
export default ActionCollectManage;
export { MapItem };
